  ...
  return (
    <div className="group relative flex cursor-pointer">
      <motion.img
        ...
        alt=""
        className="rounded-full w-14 h-14 sm:h-24 sm:w-24 object-cover border-gray-500 md:w-26 md:h-26 xl:w-28 xl:h-28 filter group-hover:grayscale transition duration-300 ease-in-out"
      />
